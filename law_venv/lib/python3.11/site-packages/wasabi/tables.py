...
def table(
    ...
    header: Iterable | None = None,
    footer: Iterable | None = None,
    divider: bool = False,
    widths: Iterable[int] | Literal["auto"] = "auto",
    max_col: int = 30,
    spacing: int = 3,
    aligns: Iterable[Literal["r", "c", "l"]] | Literal["r", "c", "l"] | None = None,
    multiline: bool = False,
    env_prefix: str = "WASABI",
    color_values: dict | None = None,
    fg_colors: Iterable | None = None,
    bg_colors: Iterable | None = None,
    # fmt: on
) -> str:
    """Format tabular data.
...
def row(
    data: Collection,
    widths: Sequence[int] | int | Literal["auto"] = "auto",
    spacing: int = 3,
    aligns: Sequence[Literal["r", "c", "l"]] | str | None = None,
    env_prefix: str = "WASABI",
    fg_colors: Sequence | None = None,
    bg_colors: Sequence | None = None,
) -> str:
    ...
    """
    env_log_friendly = os.getenv(f"{env_prefix}_LOG_FRIENDLY", False)
    show_colors = (
        supports_ansi()
