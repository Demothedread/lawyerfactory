...
class TracebackPrinter:
    def __init__(
        self,
        color_error: str | int = "red",
        color_tb: str | int = "blue",
        color_highlight: str | int = "yellow",
        indent: int = 2,
        tb_base: str | None = None,
        ...
        self.indent = " " * indent
        if tb_base == ".":
            tb_base = f"{os.getcwd()}{os.path.sep}"
