...
from .. import about
from ..util import (ensure_path, get_git_version, git_checkout,
...
def project_clone_cli(
    ...
    dest: Path | None = Arg(None, help="Where to clone the project. Defaults to current working directory", exists=False),
    repo: str = Opt(DEFAULT_REPO, "--repo", "-r", help="The repository to clone from"),
    branch: str | None = Opt(None, "--branch", "-b", help=f"The branch to clone from. If not provided, will attempt {', '.join(DEFAULT_BRANCHES)}"),
