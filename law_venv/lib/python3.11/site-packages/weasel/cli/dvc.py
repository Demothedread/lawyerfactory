...
from ..util import (get_hash, join_command, load_project_config, run_command,
                    working_dir)
...
def project_update_dvc_cli(
    ...
    workflow: str | None = Arg(None, help=f"Name of workflow defined in {PROJECT_FILE}. Defaults to first workflow if not set."),
...
def check_workflows(workflows: list[str], workflow: str | None = None) -> None:
