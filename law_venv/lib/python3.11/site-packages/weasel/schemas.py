...
try:
    from pydantic.v1 import (BaseModel, Field, StrictStr, ValidationError,
                             root_validator)
except ImportError:
...
class ProjectConfigAssetURL(BaseModel):
    ...
    url: StrictStr | None = Field(None, title="URL of asset")
    checksum: str | None = Field(None, title="MD5 hash of file", regex=r"([a-fA-F\d]{32})")
...
class ProjectConfigAssetGit(BaseModel):
    ...
    checksum: str | None = Field(None, title="MD5 hash of file", regex=r"([a-fA-F\d]{32})")
    description: StrictStr | None = Field(None, title="Description of asset")
    # fmt: on
...
class ProjectConfigCommand(BaseModel):
    ...
    help: StrictStr | None = Field(None, title="Command description")
...
class ProjectConfigSchema(BaseModel):
    ...
    assets: list[ProjectConfigAssetURL | ProjectConfigAssetGit] = Field([], title="Data assets")
    workflows: dict[StrictStr, list[StrictStr]] = Field({}, title="Named workflows, mapped to list of project commands to run in order")
    commands: list[ProjectConfigCommand] = Field([], title="Project command shortucts")
    title: str | None = Field(None, title="Project title")
    # fmt: on
