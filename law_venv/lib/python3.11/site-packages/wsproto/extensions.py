...
from .frame_protocol import (CloseReason, FrameDecoder, FrameProtocol, Opcode,
                             RsvBits)
...
class PerMessageDeflate(Extension):
    ...
    def __init__(
        ...
        self._compressor: zlib._Compress | None = None  # noqa
        self._decompressor: zlib._Decompress | None = None  # noqa
