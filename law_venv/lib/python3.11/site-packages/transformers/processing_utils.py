...
from .tokenization_utils_base import (PaddingStrategy, PreTokenizedInput,
                                      ...
                                      TruncationStrategy)
from .utils import (AUDIO_TOKENIZER_NAME, CHAT_TEMPLATE_DIR,
                    CHAT_TEMPLATE_FILE, LEGACY_PROCESSOR_CHAT_TEMPLATE_FILE,
                    PROCESSOR_NAME, PushToHubMixin, TensorType, cached_file,
                    copy_func, direct_transformers_import, download_url,
...
class ProcessorMixin(PushToHubMixin):
    ...
    def get_processor_dict(
        ...
        if resolved_audio_tokenizer_file is not None:
            with open(resolved_audio_tokenizer_file, encoding="utf-8") as reader:
