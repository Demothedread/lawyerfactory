...
from .utils import (VIDEO_PROCESSOR_NAME, TensorType, add_start_docstrings,
                    cached_file, copy_func, download_url, is_offline_mode,
                    is_remote_url, is_torch_available,
                    is_torchvision_available, is_torchvision_v2_available,
                    is_vision_available, logging)
from .utils.import_utils import requires
from .video_utils import (VideoInput, VideoMetadata, group_videos_by_shape,
                          load_video, make_batched_videos, reorder_videos,
...
class BaseVideoProcessor(BaseImageProcessorFast):
    ...
    def sample_frames(
        self,
        video: "torch.Tensor",
        metadata: VideoMetadata | dict | None = None,
    ...
    def _preprocess(
        ...
        video_metadata: list[VideoMetadata] | list[dict],
        do_convert_rgb: bool,
        do_resize: bool,
        size: SizeDict,
