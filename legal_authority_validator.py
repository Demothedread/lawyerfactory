    ...
    async def _analyze_federal_preemption(self, federal_citations: List[LegalCitation],
        ...
        try:
            ...
            if preemption_type == "complete":
                notes = f"Complete federal preemption likely applies. Federal authority should control."
            elif preemption_type == "partial":
                notes = f"Partial federal preemption may apply. Both federal and state authorities relevant."
            else:
