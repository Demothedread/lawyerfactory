...
P01="$PH_ROOT/01_intake"                 # ingestion + initial evidence table scaffolding
...
shim_top knowledge_graph.py            lawyerfactory.phases.01_intake.ingestion.knowledge_graph_root
...
shim_top assessor.py                   lawyerfactory.phases.01_intake.ingestion.assessor
